    ...
    <>
      ...
      <Dialog open={isOpen && !showGoogleForms} onOpenChange={onClose}>
        ...
        >
          <DialogHeader>
            <DialogTitle
              className={cn("text-2xl flex items-center gap-2", theme === "dark" ? "text-white" : "text-gray-900")}
            >
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className={cn("border-t pt-2 mt-2", theme === "dark" ? "border-gray-600" : "border-gray-300")}>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="name" className={cn(theme === "dark" ? "text-white" : "text-gray-900")}>
                  Full Name *
                </Label>
                <Input
                  id="name"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className={cn(theme === "dark" ? "text-white" : "text-gray-900")}>
                  Email Address *
                </Label>
                <Input
                  id="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="phone" className={cn(theme === "dark" ? "text-white" : "text-gray-900")}>
                  Phone Number *
                </Label>
                <Input
                  id="phone"
      ...
      <Dialog open={showGoogleForms} onOpenChange={handleGoogleFormsClose}>
        <DialogContent
          className={cn(
            "max-w-2xl max-h-[90vh] transition-colors duration-300",
            theme === "dark" ? "bg-[#121212] border-[#333333]" : "bg-white border-gray-200",
          )}
        >
          <DialogHeader>
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className={cn("text-xl font-semibold mb-4", theme === "dark" ? "text-white" : "text-gray-900")}>
                🎉 Payment Successful!
              </h3>
            ...
            <div className="flex justify-center">
              <Button onClick={handleGoogleFormsClose} variant="outline" className="bg-transparent">
                Close
              </Button>
            </div>
          </div>
